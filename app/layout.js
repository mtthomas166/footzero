...
export const metadata = {
  ...
  verification: {
    google: 'yP1P7adZL0cO99j_ضع_الكود_الكامل_هنا',
  },
};
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      ...
      <body className="antialiased min-h-screen relative bg-zinc-50 text-zinc-900 dark:bg-[#040405] dark:text-zinc-100 flex flex-col items-center transition-colors duration-300 w-full" suppressHydrationWarning>
        {/* Glow Effects */}
        <div className="glow-orb glow-orb-purple w- h- -top- -left- opacity-5 dark:opacity-15 transition-opacity duration-300" />
          ...
          <div className="flex h-16 w-full max-w-6xl mx-auto items-center justify-between px-4 sm:px-6 lg:px-8">
            <a href="/" className="flex items-center gap-3 group transition-all">
              ...
              <div className="flex flex-col">
                <span className="text- font-bold tracking-tight text-zinc-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors">FootyLive</span>
                <span className="text- text-zinc-500 dark:text-zinc-500 font-medium -mt-1 tracking-wider uppercase">Premium streams</span>
              </div>
            </a>
